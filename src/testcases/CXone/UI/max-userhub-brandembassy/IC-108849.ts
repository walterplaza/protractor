...
describe('max-userhub-brandembassy - IC-108849', function () {
    ...
    beforeEach(async () => {
        await Logger.write(FunctionType.TESTCASE, 'IC-108849 - [Patron][BE] Verify that BE workspace is displayed by default when WFM is enabled');
        // Preconditions
    ...
    it('IC-108849 - [Patron][BE] Verify that BE workspace is displayed by default when WFM is enabled', async () => {
        //Launch MAX
