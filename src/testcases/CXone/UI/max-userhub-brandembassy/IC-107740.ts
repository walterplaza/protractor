...
describe('max-userhub-brandembassy - IC-107740', function () {
    ...
    beforeEach(async () => {
        await Logger.write(FunctionType.TESTCASE, 'IC-107740 - [Patron][BE]Verify that the BE is closed once press the X');
        // Preconditions
    ...
    it('IC-107740 - [Patron][BE]Verify that the BE is closed once press the X', async () => {
        //Launch MAX
