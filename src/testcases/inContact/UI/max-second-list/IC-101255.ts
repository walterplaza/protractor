...
describe("MAX suite - IC-101255", function () {
    ...
    beforeEach(async () => {
        await Logger.write(FunctionType.TESTCASE, `IC-101255 - Parked email unselectable`);
    ...
    it('IC-101255 - Parked email unselectable', async () => {
