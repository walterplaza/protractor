...
describe("MAX suite - IC-101278", function () {
    ...
    beforeEach(async () => {
        await Logger.write(FunctionType.TESTCASE, `IC-101278 - MAX- Unparked Email in Personal Queue Click Yes on Requeue Message`);
    ...
    it('IC-101278 - MAX- Unparked Email in Personal Queue Click Yes on Requeue Message', async () => {
        ...
        expect(await maxPage.isPersonalQueueContactDisplayed()).toBe(true, "Email is not moved to the Personal Queue of the Agents after unparking");

        //7. Log off the agent > Click Yes on the Requeue Personal Queue Items 
