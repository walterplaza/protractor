...
describe('Max-Common > MAX-Chat - IC-107861', function () {
    ...
    beforeEach(async () => {
        await Logger.write(FunctionType.TESTCASE, `IC-107861 - [MAX][SCH][Chat] No Chat/SMS skills assigned to the agent, “Multi Chat display” does not appears on the Settings menu`);
    ...
    it('IC-107861 - [MAX][SCH][Chat] No Chat/SMS skills assigned to the agent, “Multi Chat display” does not appears on the Settings menu', async () => {
        ...
        expect( await maxPage.isMultiChatDisplayDisplayed()).toBe(false, "Multi Chat display button does not display default status 'ON'");                  
    });
