...
let testCaseName: string = "Returns an Agent Indicator List";

describe(`${testCaseName} - ${TestRunInfo.versionAPI}`, function () {
    let chatAgent: Agent;

    // Read Data
    let dataFullTest = Utility.readJsonAPI(`admin/agent-management/returns-an-agent-indicator-list/returns-an-agent-indicator-list-${TestRunInfo.versionAPI}.json`);
