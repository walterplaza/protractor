 ...
 * Type: API
 * Suite: inContact API
 * TC ID: RPV80033, RPV80034, RPV80035, RPV80036, RPV80037, RPV80038, RPV80039, RPV80040, RPV80041
 * Tested cluster: SC10
 */
let testCaseName: string = "Returns Completed Contacts";

describe(`${testCaseName} - ${APIVersion.V8}`, async function () {
    ...
    // Read Data
    let dataFullTest = Utility.readJsonAPI(`reporting/historical-reporting/returns-completed-contacts/returns-completed-contacts-${APIVersion.V8}.json`);
    ...
    dataFullTest.map(function (testCaseData) {
        it(`${testCaseData.Id} - ${testCaseName} ${testCaseData.Description} ${APIVersion.V8}`, async function () {
            await Logger.write(FunctionType.TESTCASE, `${testCaseData.Id} - ${testCaseName} ${testCaseData.Description} ${APIVersion.V8}`);
            ...
            for (let caseData of testCaseData.Data) {
                ...
                if (testCaseData.Id == "RPV80037") {
                    ...
                    if (testCaseData.Id == "RPV80034") {
                        //Required infomation
                        startDate = startDateOrg;
                        endDate = endDateOrg;
                    } else if (testCaseData.Id == "RPV80036") {
                    ...
                    } else if (testCaseData.Id == "RPV80035") {
                        //Invalid Token
                        monitorAgent.accessToken = monitorAgent.accessToken + "invalid"
                    } else if (testCaseData.Id == "RPV80038") {
                    ...
                    } else if (testCaseData.Id == "RPV80040") {
                        if (caseData.QueryParams.startDate != "") {
                    ...
                    } else if (testCaseData.Id == "RPV80033") {
