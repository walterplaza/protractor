...
describe(`${testCaseName} - ${APIVersion.V12}`, async function () {
    ...
    // Read Data
    let dataFullTest = Utility.readJsonAPI(`reporting/historical-reporting/returns-sla-summary-for-a-skill/returns-sla-summary-for-a-skill-${APIVersion.V12}.json`);
