...
describe(`${testCaseName} - ${APIVersion.V12}`, async function () {
    ...
    // Read Data
    let dataFullTest = Utility.readJsonAPI(`real-time-data/real-time-reporting/returns-active-contact-states/returns-active-contact-states-${APIVersion.V12}.json`);
