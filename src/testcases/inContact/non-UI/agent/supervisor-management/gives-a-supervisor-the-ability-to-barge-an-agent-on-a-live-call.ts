...
let testCaseName = "Gives a supervisor the ability to barge an agent on a live call";
...
describe(`${testCaseName} - ${TestRunInfo.versionAPI}`, function () {
    ...
    // Read Data
    let dataFullTest = Utility.readJsonAPI(`agent/supervisor-management/gives-a-supervisor-the-ability-to-barge-an-agent-on-a-live-call/gives-a-supervisor-the-ability-to-barge-an-agent-on-a-live-call-${TestRunInfo.versionAPI}.json`);
            ...
            for (let caseData of testCaseData.Data) {
                ...
                if (testCaseData.Id == "AGV20047") {
                    ...
                    for (let i = 0; i < textArr.length; i++) {
                        ...
                        res = await supervisorManagementAPI.givesASupervisorTheAbilityToBargeAnAgentOnALiveCall(targetAgent);
