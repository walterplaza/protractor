...
export let config: Config = {
    ...
    specs: [
       // `${ProjectPath.testCases}/inContact/UI/MAX-Chat/IC-64395.js`,
       // `${ProjectPath.testCases}/inContact/UI/MAX-Chat/IC-63024.js`,
       // `${ProjectPath.testCases}/inContact/UI/MAX-Chat/IC-89959.js`,
       // `${ProjectPath.testCases}/inContact/UI/MAX-Chat/IC-80910.js`,
        `${ProjectPath.testCases}/inContact/UI/MAX-Chat/IC-98650.js`,
    ]
};