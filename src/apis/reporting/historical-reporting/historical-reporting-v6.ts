...
export default class HistoricalReportingVersion6 implements IHistoricalReporting {
    ...
    returnsAPerformanceSummaryOfAllAgents(agent: Agent, startDate: any , endDate: any , fields: any = ""): Promise<APIResponse> {
        throw new Error("Method not implemented.");
    }
    ...
    async returnsCompletedContacts(agent: Agent, startDate: any = "", endDate: any = "", updatedSince: any = "", fields: any = "", skip: any = "", top: any = "", orderby: any = "", mediaTypeId: any = "", skillId: any = "", agentId: any = "", campaignId: any = "", teamId: any = "", toAddr: any = "", fromAddr: any = "", isLogged: any = "", isRefused: any = "", isTakeover: any = "", tags: any = ""): Promise<APIResponse> {
        try {
            let options = new Options(`${agent.baseUri}services/v6.0/contacts/completed`, Method.GET);
    ...
    returnsPerformanceSummaryOfAllTeams(agent: Agent, startDate: any = "", endDate: any = "", fields: any = ""): Promise<APIResponse> {
        throw new Error("Method not implemented.");
    }
}