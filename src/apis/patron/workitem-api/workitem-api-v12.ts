...
export default class WorkItemAPIVersion12 implements IWorkItemAPI {
    async createANewWorkItem(agent: Agent, pointOfContact: any = "", workItemId: any = "", workItemPayload: any = "", workItemType: any = "", from: any = "") {
        try {
            let options = new Options(`${agent.baseUri}services/v12.0/interactions/work-items`, Method.POST);
