...
export default class PhoneCallManagementVersion7 implements IPhoneCallManagement {
    ...
    async dialsAnOutboundCall(agent: Agent, phoneNumber: any, skillName: any): Promise<APIResponse> {
        try {
            let options = new Options(`${agent.baseUri}services/v7.0/agent-sessions/${agent.sessionId}/dial-phone`, Method.POST);
