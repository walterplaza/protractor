...
export default class PhoneCallManagementVersion6 implements IPhoneCallManagement {

    dialsAnAgentsPersonalQueue(agent: Agent, targetAgentId: any, parentContactId: any = ""): Promise<APIResponse> {
        throw new Error("Method not implemented.");
    }

    async dialsAnOutboundCall(agent: Agent, phoneNumber: any, skillName: any = ""): Promise<APIResponse> {
        try {
            let options = new Options(`${agent.baseUri}services/v6.0/agent-sessions/${agent.sessionId}/dial-phone`, Method.POST);
    ...
    dialAgentConsult(agent: Agent, targetAgentId: any, parentContactId: any=""):Promise<APIResponse> {
        throw new Error("Method not implemented.");
    }
    ...
    acceptConsultRequest(agent: Agent, contactId: any):Promise<APIResponse> {
        throw new Error("Method not implemented.");
    }
    overrideAmdOnACall() {
        throw new Error("Method not implemented.");
