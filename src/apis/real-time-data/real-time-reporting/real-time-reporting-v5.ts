...
export default class RealTimeReportingVersion5 implements IRealTimeReporting {
    ...
    async returnsActivityForAllSkills(agent: Agent, mediaTypeId: any = "", isOutbound: any = "", fields: any = "", updatedSince: any = ""): Promise<APIResponse> {
        try {
            let options = new Options(`${agent.baseUri}services/v5.0/skills/activity`, Method.GET);
