...
export default class ConditionsPopup extends NavigationBar {
    ...
    public async selectOperator(operator: string): Promise<ConditionsPopup> {
        try {
            ...
            throw new errorwrapper.CustomError(this.selectOperator, err.message);
        }
    }
    ...
    * Get entered value
    ...
    public async getAddConditionAlertMessages(): Promise<string> {
        try {
            ...
            throw new errorwrapper.CustomError(this.getAddConditionAlertMessages, err.message);
        }
    }
