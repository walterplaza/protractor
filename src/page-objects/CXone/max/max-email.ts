...
import { Email, EmailButtonTitle, EmailMode, EmailTinyToolButton, EmailParkMode } from "@data-objects/inContact/max/email/email-info";
...
export default class MaxEmailPage extends MaxPage {
    ...
    protected tblRichText = new ElementWrapper(by.xpath("//div[@class='mce-toolbar-grp mce-container mce-panel mce-first mce-stack-layout-item']"));
    protected txtBody = new ElementWrapper(by.xpath("//div[@class='mce-edit-area mce-container mce-panel mce-last mce-stack-layout-item']"));
    ...
    protected divEMailEditor = new ElementWrapper(by.xpath("//div[@class='email-editor']//div[@class='mce-toolbar-grp mce-container mce-panel mce-first mce-stack-layout-item']"));
    ...
    public async highLightEmailBodyText(): Promise<MaxEmailPage> {
        try {
            ...
            if (TestRunInfo.browser == Browser.FIREFOX || TestRunInfo.browser == Browser.INTERNET_EXPLORER) {
                ...
                await BrowserWrapper.getActions().keyDown(Key.CONTROL).sendKeys("a").perform();
            }
            return this;
        } catch (err) {
